  ...
  if (!isIntroShownInSession) {
    const driverObj = driver({
      ...
      steps: [
        ...
        { element: ".menu > li:nth-child(4)", popover: { title: "Les demandes d'achats", description: "Ceci est la section des demandes d'achats.", side: "bottom", align: "start" }},
        { element: ".menu > li:nth-child(5)", popover: { title: "Section des inventaires", description: "Vous pouvez vous les inventaires dans cette partie.", side: "bottom", align: "start" }},
        { element: ".theme-toggle", popover: { title: "Mutli-thème", description: "Vous pouvez switchez votre thème si vous voulez.", side: "bottom", align: "start" }},
