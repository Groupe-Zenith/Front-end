...
import scanlogo from "../../assets/images/scan.jpg";
...
const Login = () => {
  ...
  const features = [
    { icon: <Code size={20} />, text: "API bancaires sécurisées" },
    { icon: <Shield size={20} />, text: "Conformité & protection des données" },
    { icon: <FileText size={20} />, text: "Documentation complète" },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Portail développeur exclusif d'Access Bank Madagascar pour
              l'intégration des services bancaires innovants
            </motion.p>
          </motion.div>
          ...
          >
            © 2025 Access Bank Madagascar. Tous droits réservés.
          </motion.div>
        </motion.div>
        ...
        >
          <div className="form-wrapper">
            ...
            >
              <div onClick={() => setScan(!scan)} className="social-button">
                <img
                  src={scanlogo}
                  alt="scan_logo"
                  className="social-icon scan-icon"
                />
              </div>
              <div className="social-button">
                <img src={google} alt="google_logo" className="social-icon" />
              </div>
            </motion.div> */}
          </div>
        </motion.div>
